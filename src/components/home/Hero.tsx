...
const Hero: React.FC = (): JSX.Element => {
  ...
  const handleOurSystem = () => {
    if (auth?.isAuthenticated) navigate("/system");
    else navigate("/login");
  };

  return (
    <div className="min-h-dvh h-fit flex flex-row items-center justify-center lg:pt-[4.5rem] px-16 md:px-28 lg:pr-0 xl:pr-16 text-black">
