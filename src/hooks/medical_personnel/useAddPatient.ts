...
import { addNewPatient } from "../../services/medical_personnel";
...
export const useAddNewPatient = () => {
    ...
    const handleAddNewPatient = async (newPatient: PatientData) => {
        setIsLoading(true);
        setError(null);
    ...
    return { response, isLoading, error, handleAddNewPatient }
}